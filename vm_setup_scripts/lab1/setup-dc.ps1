...
if ($env:COMPUTERNAME -ne "DC01") {
    ...
    powershell -ep bypass C:\Users\Administrator\AdversaryEmulation\vm-setup-scripts\lab1\disable-defender.ps1;
    ...
    powershell -ep bypass C:\Users\Administrator\AdversaryEmulation\vm-setup-scripts\lab1\rename-dc.ps1;
} 
#Step 2
elseif ((Get-WmiObject -Namespace root\cimv2 -Class Win32_ComputerSystem).Domain -ne "MAD.local") {
    ...
    powershell -ep bypass C:\Users\Administrator\AdversaryEmulation\vm-setup-scripts\lab1\create-domain.ps1;
}
#Step 3
else {
    #Add domain entities (computer accounts, organizational units, and user accounts)
    powershell -ep bypass C:\Users\Administrator\AdversaryEmulation\vm-setup-scripts\lab1\add-domain-entities.ps1;

    #Download needed tools for emulation procedure
    powershell -ep bypass C:\Users\Administrator\AdversaryEmulation\vm-setup-scripts\lab1\download-tools.ps1;
